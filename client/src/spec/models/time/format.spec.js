...
describe('format', () => {
  describe('forCalendar()', () => {
    it('is formatted properly', () => {
      const moment = Moment.utc([2018, 11, 25]);
  ...
  describe('forSchedule()', () => {
    describe('when the moment has minutes', () => {
      it('is formatted properly', () => {
        const moment = Moment.utc([2018, 11, 25, 8, 15]);
    ...
    describe('when the moment does not have minutes', () => {
      it('is formatted properly', () => {
        const moment = Moment.utc([2018, 11, 25, 8, 0]);
  ...
  describe('forServer()', () => {
    it('is formatted properly', () => {
      const moment = Moment.utc([2018, 11, 25]);
      expect(format.forServer(moment)).toEqual('2018-12-25T00:00:00.000Z');
    });
  });

  describe('shortWeekdayOnly()', () => {
    it('is formatted properly', () => {
      const moment = Moment.utc([2018, 11, 25]).startOf('week');
